    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/role/findAll.do">航班信息</a></li>
                        ...
                        <table id="collapse-table" class="table table-bordered table-hover dataTable">
                            ...
                            <c:forEach items="${flightList}" var="flight" varStatus="status">
                                ...
                                <tr data-tt-id="'${status.index}' + - + '${status.index+3}'" data-tt-parent-id="${status.index}">
                                    ...
                                    <td class="text-center" colspan="2">
                                        <a href="#" onclick="bookTicket()" class="btn bg-olive btn-xs">订票</a>                                    </td>
                                </tr>
...
<script>
    /*
        * 旅客没有订票的权限，当点击订票时，会出现提示信息
        *
        * */
    function bookTicket(){
        alert("您并未订票权限，请联系您的旅行社为您订票！！！")
    }
