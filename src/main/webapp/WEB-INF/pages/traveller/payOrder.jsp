                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc">支付状态</th>
                                <td>支付时间</td>
                                <th class="sorting_asc sorting_asc_disabled">舱位等级</th>
                                <th class="sorting_desc">订单价格</th>
                                <th class="sorting_asc sorting_asc_disabled">操作</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${flightOrderList}" var="flightOrder" varStatus="status">
                            <tr>
                                <td>${status.count}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="${pageContext.request.contextPath}/travellerController/printTicket?id=${flightOrder.id}" class="btn bg-olive btn-xs">打印</a>
                                </td>
                            </tr>
                            </c:forEach>
                            <!--
...
<script>
    $(document).ready(function() {
        //对退换进行提示，只有旅行社才可以更换航班
        $("#exit").click(function () {
            alert("请联系您的旅行社管理员进行【退换】操作");
        })
        // 选择框
        $(".select2").select2();
