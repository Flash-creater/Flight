        ...
        <section class="content"> <!--订单信息-->
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="航班编号"
                               value="${flight.flightId}" readonly="readonly">
                    </div>
                    <div class="col-md-2 title">出发城市</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="出发城市"
                               value="${flight.departureCity }" readonly="readonly">
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <table id="dataList"
                    ...
                    <tr>
                        <td>成人</td>
                        <td>
                            <input type="text" size="10" value="${flight.traveller.trueName}" name="trueName" readonly class="form-control">
                        </td>
                        <td>
                            <input type="text" size="10" value="${flight.traveller.sex}" name="sex" readonly class="form-control" id="sex">

                        </td>
                        <td><input type="text" size="20"
                                   value="${flight.traveller.phone}" name="phone" id="phone" class="form-control" readonly></td>
                        <td><input type="text" size="15"
                                   value="居民身份证" readonly="readonly" class="form-control">
                        </td>
                        <td>
                            <input type="password" size="28" value="${flight.traveller.ID_Card}" name="ID_Card" id="ID_Card" class="form-control" readonly="readonly">
                        </td>
                        <td><input type="text" size="15"
                                   value="${param.beat}" readonly="readonly" class="form-control">
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data text">${user.contactName}</div>

                    <div class="col-md-2 title">手机号</div>
                    <div class="col-md-4 data text">${user.contactPhone}</div>
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="${param.price}" name="price" readonly="readonly"/>
