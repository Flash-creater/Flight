                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="id" readonly
                                   placeholder="旅行社编号" value="${user.id}">
                        </div>
                        <div class="col-md-2 title">旅行社名称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="agencyName" readonly
                                   placeholder="旅行社名称" value="${user.agencyName}">
                        </div>
                        <div class="col-md-2 title">联系人姓名</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="contactName" readonly="readonly"
                                   placeholder="联系人姓名" value="${user.contactName}">
                        </div>
                        <div class="col-md-2 title">联系人电话</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="contactPhone" readonly
                                   placeholder="联系电话" value="${user.contactPhone}">
                        </div>
                        ...
                        <div class="col-md-2 title">旅行社描述</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="contactPhone" readonly="readonly"
                                   placeholder="旅行社描述" value="${user.agencyInfo}">
                        </div>
                    </div>
                </div>
                <!--订单信息/--> <!--工具栏-->
